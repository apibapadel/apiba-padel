...
<div class="grid grid--2">
  ...
  <!-- Card: Bienvenida / Acciones -->
  <div class="card">
    <div class="card__header">
      <h1 class="h1">APiBA Pádel</h1>
      <span class="badge">Sitio público</span>
    </div>
    <div class="card__body">
      <p class="p">Consultá torneos y noticias. Para inscribirte o gestionar, ingresá con tu cuenta.</p>
